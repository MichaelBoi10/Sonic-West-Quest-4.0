...
MusicIndex:
ptr_mus81:	SMPS_MUSIC_METADATA	Music81, s1TempotoS3($3A), 0	; GHZ
...
ptr_mus94:	SMPS_MUSIC_METADATA	Music94, s1TempotoS3($3A), 0	; GHZ
ptr_musend
...
Music81:	include "sound/music/music81.asm"
	even
Music82:	include "sound/music/music82.asm"
	even
Music83:	include "sound/music/music83.asm"
	even
Music84:	include "sound/music/music84.asm"
	even
Music85:	include "sound/music/music85.asm"
	even
Music86:	include "sound/music/music86.asm"
	even
Music87:	include "sound/music/music87.asm"
	even
Music88:	include "sound/music/Mus88 - Extra Life.asm"
	even
Music89:	include "sound/music/Mus89 - Special Stage.asm"
	even
Music8A:	include "sound/music/music8A.asm"
	even
Music8B:	include "sound/music/music8B.asm"
	even
Music8C:	include "sound/music/music8C.asm"
	even
Music8D:	include "sound/music/Mus8D - FZ.asm"
	even
Music8E:	include "sound/music/music8E.asm"
	even
...
Music93:	include "sound/music/Mus93 - Get Emerald.asm"
	even
Music94:	include "sound/music/Menu.asm"
	even
