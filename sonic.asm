...
Pal_Sega:	bincludeEndMarker	"palette/Sega Screen.bin"
...
; ---------------------------------------------------------------------------
		...
		copyTilemap	v_ram_start,vram_bg+$61C,12,4 ; transfer decompressed patterns to VRAM (BG plane, light scanning effect)
...
; ---------------------------------------------------------------------------
		...
		move.b	#bgm_Emerald,d0			; set stop music command
		bsr.w	QueueSound1			; stop music
...
.LevSelClearBG:	move.l	d0,(a6)				; clear background plane
		...
		move.w	#bgm_LevSel,d0			; is sound $80-$93 being played?
		bsr.w	QueueSound1		; play selected sound
; ---------------------------------------------------------------------------
...
LevSel_UpDown:
		...
		move.w	#sfx_Switch,d0			; is sound $80-$93 being played?
		bsr.w	QueueSound2		; play selected sound
		move.w	(v_levselitem).w,d0		; get currently selected line
...
; >>> Main Sonic player object
		...
		include	"_incObj/06 AfterImage.asm"	; <-- add this
