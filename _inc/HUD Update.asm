...
HUD_Update:
		...
		move.l	#$5C800003,d0	; set VRAM address ;Mercury Macros
...
loc_1C6E4:
		clr.b	(f_ringcount).w
		move.l	#$5F400003,d0	; set VRAM address ;Mercury Macros
		moveq	#0,d1
...
loc_1C734:
		move.l	#$5E400003,d0	; set VRAM address ;Mercury Macros
		moveq	#0,d1
		move.b	(v_timemin).w,d1 ; load	minutes
		bsr.w	Hud_Mins
		move.l	#$5EC00003,d0	; set VRAM address ;Mercury Macros
		moveq	#0,d1
...
Hud_Lives:				; XREF: Hud_ChkLives
		move.l	#$7BA00003,d0	; set VRAM address ;Mercury Macros
		moveq	#0,d1
